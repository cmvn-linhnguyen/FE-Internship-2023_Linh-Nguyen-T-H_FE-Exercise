...
export const renderProducts = (products: Product[]): HTMLUListElement => {
              ...
              ${
                product.discount
                  ? `<div class="product-price-group flex-row flex-space-between">
                      <p class="product-price product-price-discount">$${product.discountedPrice.toFixed(
                        2
                      )}</p>
...
export const displayProducts = (products: Product[]): void => {
